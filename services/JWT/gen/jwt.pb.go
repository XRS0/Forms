...
func (x *VerifyTokenResponse) GetAccess() bool {
	if x != nil {
		return x.Access
	}
	return false
...
var file_jwt_proto_rawDesc = []byte{
	...
	,
...
var file_jwt_proto_goTypes = []interface{}{
	(*CreateTokenRequest)(nil),  // 0: jwt.CreateTokenRequest
	(*CreateTokenResponse)(nil), // 1: jwt.CreateTokenResponse
	(*VerifyTokenRequest)(nil),  // 2: jwt.VerifyTokenRequest
	(*VerifyTokenResponse)(nil), // 3: jwt.VerifyTokenResponse
}
var file_jwt_proto_depIdxs = []int32{
	0, // 0: jwt.AuthService.CreateJWTToken:input_type -> jwt.CreateTokenRequest
	2, // 1: jwt.AuthService.VerifyJWTToken:input_type -> jwt.VerifyTokenRequest
	1, // 2: jwt.AuthService.CreateJWTToken:output_type -> jwt.CreateTokenResponse
	3, // 3: jwt.AuthService.VerifyJWTToken:output_type -> jwt.VerifyTokenResponse
